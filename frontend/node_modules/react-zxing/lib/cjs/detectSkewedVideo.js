...
const rotateImageData = (source, degrees) => {
...
const detectSkewedVideo = async (video, detector, skewAngle) => {
...
exports.detectSkewedVideo = detectSkewedVideo;
